	...
	static sendDeliveredOrderEmail = async (
		...
		try {
			const deliveredDate = order.deliveredAt
				? formatDate(order.deliveredAt, order.country)
				: formatDate(order.updatedAt, order.country);
			...
			const itemsHTML = order.items
                ...
                <tr>
                    ...
                    <td style="padding: 12px 16px; border-bottom: 1px solid #f1f5f9; text-align: right; font-weight: 600; color: #16a34a;">${formatCurrency(item.lineTotal, order.currency)}</td>
                </tr>`,
				)
				.join("");
...
<head>
    ...
    <title>Orden Entregada - Portal SPT</title>
</head>
                ...
                <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                    ...
                    <tr>
                        <td style="background: linear-gradient(135deg, #ea580c 0%, #fb923c 100%); padding: 40px 20px; text-align: center;">
                            ...
                            <h1 style="margin: 0; font-size: 26px; font-weight: 700; color: #ffffff;">¡Orden Entregada! 🎉</h1>
                            <p style="margin: 8px 0 0 0; font-size: 15px; color: rgba(255,255,255,0.9);">Tu pedido ha sido entregado exitosamente</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 40px 35px; background-color: #ffffff;">
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="margin: 0 0 30px 0; background-color: #f0fdf4; border-left: 4px solid #16a34a; border-radius: 6px;">
                                <tr>
                                    <td style="padding: 16px 20px;">
                                        <p style="margin: 0 0 4px 0; font-size: 14px; font-weight: 600; color: #16a34a;">✅ Entregado el</p>
                                        <p style="margin: 0; font-size: 16px; font-weight: 700; color: #166534;">${deliveredDate}</p>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    <td style="padding: 20px 25px;">
                                        <table role="presentation" cellpadding="0" cellspacing="0" width="100%">
                                            ...
                                            <tr>
                                                <td style="padding: 7px 0; font-size: 14px; color: #64748b;">Fecha de Entrega:</td>
                                                <td style="padding: 7px 0; font-size: 14px; font-weight: 600; color: #16a34a; text-align: right;">${deliveredDate}</td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 7px 0; font-size: 14px; color: #64748b;">Estado:</td>
                                                <td style="padding: 7px 0; text-align: right;">
                                                    <span style="background-color: #dcfce7; color: #166534; padding: 4px 12px; border-radius: 20px; font-size: 13px; font-weight: 600;">✅ Entregado</span>
                                                </td>
                                            </tr>
                                            <tr>
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="margin: 0 0 30px 0; border: 1px solid #e2e8f0; border-radius: 10px; overflow: hidden;">
                                <tr>
                                    <td style="padding: 18px 25px; border-bottom: 2px solid #e2e8f0; background-color: #f8fafc;">
                                        <h2 style="margin: 0; font-size: 17px; font-weight: 600; color: #1e293b;">📦 Productos Entregados</h2>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <table role="presentation" cellpadding="0" cellspacing="0" width="100%">
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <td colspan="3" style="padding: 16px; text-align: right; font-size: 16px; font-weight: 700; color: #1e293b; border-top: 2px solid #e2e8f0;">Total Pagado:</td>
                                                    <td style="padding: 16px; text-align: right; font-size: 18px; font-weight: 700; color: #16a34a; border-top: 2px solid #e2e8f0;">${formatCurrency(order.total, order.currency)}</td>
                                                </tr>
                                            </tfoot>
                                        </table>
                                    </td>
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="margin: 0 0 30px 0; background-color: #fff7ed; border-left: 4px solid #ea580c; border-radius: 6px;">
                                <tr>
                                    <td style="padding: 20px 25px;">
                                        <p style="margin: 0 0 12px 0; font-size: 15px; font-weight: 600; color: #ea580c;">📍 Entregado en</p>
                                        <table role="presentation" cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
                                                <td style="padding: 5px 0; font-size: 14px; color: #64748b; width: 40%;">Destinatario:</td>
                            ...
                            <p style="margin: 0; font-size: 14px; line-height: 1.6; color: #94a3b8; text-align: center;">
                                ¿Algún problema con tu entrega? Contáctanos en <a href="mailto:${process.env.ADMIN_EMAIL}" style="color: #ea580c; text-decoration: none;">${process.env.ADMIN_EMAIL}</a>
                            </p>
                        </td>
                    </tr>
